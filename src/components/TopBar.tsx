...
export default function TopBar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-40 h-14 bg-[#F7FAF9]/90 backdrop-blur-sm border-b border-[#DCE5E1] flex items-center px-4 relative">
        {/* Logo — venstre */}
        ...
        <button
          ...
          className="ml-auto w-9 h-9 rounded-xl flex items-center justify-center text-[#6B7A74] hover:text-[#0E1512] active:scale-90 transition"
